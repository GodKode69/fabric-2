...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    const img = await new DIG.Deepfry().getImage(pngavatar);
    const attach = new AttachmentBuilder(img, { name: "fabric-deepfry.png" });
    let embed = new EmbedBuilder()
      .setColor(client.color)
      .setDescription(`Look At ${member.username}`)
      .setImage("attachment://fabric-deepfry.png");
