...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    const img = await new DIG.NotStonk().getImage(pngavatar);
    const attach = new AttachmentBuilder(img, { name: "fabric-notstonk.png" });
    let embed = new EmbedBuilder()
      .setColor(client.color)
      .setDescription(`Look At ${member.username}`)
      .setImage("attachment://fabric-notstonk.png");
