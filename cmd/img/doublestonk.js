...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    const img = await new DIG.DoubleStonk().getImage(pngfirst, pngavatar);
    const attach = new AttachmentBuilder(img, { name: "fabric-doubelstonk.png" });
    let embed = new EmbedBuilder()
      .setColor(client.color)
      .setDescription(`Look At ${member.username}`)
      .setImage("attachment://fabric-doubelstonk.png");
